...
from ultralytics.utils.torch_utils import (EarlyStopping, ModelEMA, de_parallel, init_seeds, one_cycle, select_device,
                                           strip_optimizer)
from ultralytics.engine.sophia import SophiaG
...
class BaseTrainer:
    ...
    def build_optimizer(self, model, name='auto', lr=0.001, momentum=0.9, decay=1e-5, iterations=1e5):
        ...
        if name in ('Adam', 'Adamax', 'AdamW', 'NAdam', 'RAdam', 'SophiaG'):
            ...
            optimizer = optim.SophiaG(g[2], lr=lr, betas=(momentum, 0.999), rho=0.04, weight_decay=0.0)
        else:
